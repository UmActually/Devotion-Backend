...
class DataSource(models.Model):
    ...
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, null=False, blank=False, related_name='data_sources')
...
class Widget(models.Model):
    ...
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, null=False, blank=False, related_name='widgets')
